...
<section class="e-section__main">
    <div class="e-content-holder e-content__center">
        ...
        <div class="e-content__text-holder">
            ...
            <p>We have 2 main user personas. Our first target group includes <strong>students</strong>. They need to learn, practice, and test their knowledge. The other target group was <strong>teachers</strong>. They need to create classes, add students, examine students, analyze their knowledge, strengths, and weaknesses, based on generated analytics.</p>
        </div>
        <div class="e-content__text-holder">
